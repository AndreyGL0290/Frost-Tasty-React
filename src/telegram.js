...
tg.MainButton.onClick(() => {
    ...
    for (let i = 0; i < Object.keys(basket.products).length; i += 1){
        data[Object.keys(basket.products)[i]] = {'price': Math.ceil(basket.products[Object.keys(basket.products)[i]].price), 'quantity': basket.products[Object.keys(basket.products)[i]].quantity}
    }
