...
tg.MainButton.onClick(() => {
    ...
    for (let i = 0; i < Object.keys(basket.products).length; i += 1){
        data[Object.keys(basket.products)[i]] = {'price': (basket.products[Object.keys(basket.products)[i]].price).toFixed(2), 'quantity': basket.products[Object.keys(basket.products)[i]].quantity, 'postfix': (basket.products[Object.keys(basket.products)[i]].postfix || '₾/кг')}
    }
